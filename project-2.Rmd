...
```{r best-gbm-training, message=FALSE}
...
cmI$table %>%
  kable(digits=3,
        caption="Image Split Confusion Matrix") %>%
  kable_styling(full_width=F,
                position = "float_left")

cmB$table %>%
  kable(digits=3,
        caption="Block Split Confusion Matrix") %>%
  kable_styling(full_width=F,
                position = "float_left")
```
...
```{r image-maps-all}
grid.arrange(blank, leg_response, leg_confusion,
             nrow = 1, ncol = 3)
grid.arrange(i_maps_folds[[1]], i_maps_response[[1]], i_maps_confusion[[1]],
             nrow = 1, ncol = 3)
grid.arrange(i_maps_folds[[2]], i_maps_response[[2]], i_maps_confusion[[2]],
             nrow = 1, ncol = 3)
grid.arrange(i_maps_folds[[3]], i_maps_response[[3]], i_maps_confusion[[3]],
             nrow = 1, ncol = 3)
```
