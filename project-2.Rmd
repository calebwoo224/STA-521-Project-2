...
```
In total, 207 pairings of the two hyperparameters were trained on both split methods, with 23 distinct values for the number of trees and 9 distinct learning rate choices. In the block split method, there was minimal difference between the different learning rates with higher numbers of trees. At lower numbers of trees, however, the parameter pair with the lowest average cross-validated loss was 10 trees with a learning rate of 0.25. For image split, higher trees meant significantly better performance with both the 0.01 and 0.025 learning rates, compared to the other learning rates. However, the best parameter pair by average cross-validated loss was 50 trees with learning rate of 0.075.
